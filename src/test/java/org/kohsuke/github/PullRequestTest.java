...
public class PullRequestTest extends AbstractGitHubApiWireMockTest {
  @Test public void createPullRequest() throws Exception {
  ...
  @Test public void createPullRequestComment() throws Exception {
    String name = "createPullRequestComment";
    GHPullRequest p = getRepository().createPullRequest(name, "test/stable", "master", "## test");
    p.comment("Some comment");
  }

  @Test public void closePullRequest() throws Exception {
  ...
  @Test public void pullRequestReviews() throws Exception {
    String name = "testPullRequestReviews";
    GHPullRequest p = getRepository().createPullRequest(name, "test/stable", "master", "## test");
    GHPullRequestReview draftReview = p.createReview().body("Some draft review").comment("Some niggle", "README.md", 1).create();
  ...
  @Test public void testPullRequestReviewRequests() throws Exception {
  ...
  @Test public void pullRequestReviewComments() throws Exception {
  ...
  @Test public void mergeCommitSHA() throws Exception {
  ...
  @Test public void squashMerge() throws Exception {
  ...
  @Test public void updateContentSquashMerge() throws Exception {
    ...
    Thread.sleep(1000);
    getRepository().createContent().content(name + name).path(name).branch(branchName).message(name).sha(response.getContent().getSha()).commit();
    GHPullRequest p = getRepository().createPullRequest(name, branchName, "master", "## test squash");
    Thread.sleep(1000);
    p.merge("squash merge", null, GHPullRequest.MergeMethod.SQUASH);
  }

  @Test public void queryPullRequestsQualifiedHead() throws Exception {
  ...
  @Test public void queryPullRequestsUnqualifiedHead() throws Exception {
    GHRepository repo = getRepository();
  ...
  @Test public void setLabels() throws Exception {
  ...
  @Test public void setAssignee() throws Exception {
  ...
  @Test public void getUser() throws IOException {
